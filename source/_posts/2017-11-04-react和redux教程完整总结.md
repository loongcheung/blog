---
layout: post
title:  "react和redux教程完整总结"
date:   2017-11-04 21:12:21 +0700
categories: 前端
tags: react
---
...
## 做React需要会什么？
react的功能其实很单一，主要负责渲染的功能，想要做好一个项目，往往需要其他库和工具的配合，比如用redux来管理数据，react-router管理路由，react已经全面拥抱es6，所以es6也得掌握，webpack就算是不会配置也要会用，要想提高性能，需要按需加载，immutable.js也得用上。。。
...
![](https://jackiedark.github.io/img/projects/diff.png)
...
![](https://jackiedark.github.io/img/projects/react-lifecycle.png)
...
![](https://jackiedark.github.io/img/projects/simple_redux.jpg)
...
![](https://jackiedark.github.io/img/projects/all_redux.png)
